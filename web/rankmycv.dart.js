...
$$.InputText = {"":"Object;_input?,_inputSet?,enStopWords?,_hits?,_DIRECT_SCORE?,_originalText",
 ...
 getDirectMatchScore$1: function(externalIt) {
  ...
  $.getInterceptor$JSArray(t2).forEach$1(t2, new $.InputText_getDirectMatchScore_anon(t1, this));
  return t1.result_1;
},
 getFilteredInputSize$0: function() {
  ...
  t2 = this._inputSet;
  $.getInterceptor$JSArray(t2).forEach$1(t2, new $.InputText_getFilteredInputSize_anon(this, verifiedWords, t1));
...
$$.main_anon = {"":"Closure;",
 call$1: function(e) {
  ...
  $.print($.getInterceptor$JSNumber(result).toInt$0(result));
  if ($.gtB(result, 100))
    result = 100;
  ...
  t2 = r.getHighlightedText$0();
  $.query("#matchedText").set$innerHtml(t2);
}
};
...
$$.InputText_getFilteredInputSize_anon = {"":"Closure;this_3,verifiedWords_2,box_0",
 call$1: function(s) {
  var t1, t2;
  if ($.gtB($.getInterceptor$JSStringJSArray(s).get$length(s), 0)) {
    t1 = this.this_3.get$enStopWords();
    if ($.getInterceptor$JSStringJSArray(t1).contains$1(t1, s) === true) {
      t1 = this.verifiedWords_2;
...
$$.InputText_getDirectMatchScore_anon = {"":"Closure;box_0,this_2",
