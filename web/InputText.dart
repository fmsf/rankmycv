...
class InputText {
  ...
  InputText(String input){
    ...
    //input = input.replaceAll(new RegExp("[^a-zA-Z 0-9]"), " ");
     ...
     enStopWords = new Set();
     enStopWords.addAll(enStopWordsList);
  ...
  String highlightText(InputText externalText){
    String text = externalText.getText().trim();
