// If you are poking arround: I am also doing this project go hands on Dart
// It is quite nice, although still young I do recommend it.
// Keep checking the project I'll add some more stuff in the future.
// Francisco MS Ferreira
// Generated stuff bellow.
...
$$.Ranker = {"":"Object;_cv,_job",
 CalculateScore$0: function() {
  var t1 = this._job.getDirectMatchScore$1(this._cv);
  if (typeof t1 !== 'number')
    throw $.iae(t1);
  return 0 + t1;
},
 getHighlightedText$0: function() {
  return this._job.highlightText$1(this._cv);
},
 getMaxScore$0: function() {
  return this._job.getFilteredInputSize$0();
},
 Ranker$0: function() {
  this._cv = $.InputText$($.query("#cv").get$value());
  this._job = $.InputText$($.query("#job").get$value());
}
};

$$.InputText = {"":"Object;_input?,_inputSet?,enStopWords?,_hits?,_DIRECT_SCORE?,_originalText",
 contains$1: function(word) {
  var t1 = this._inputSet;
  return $.getInterceptor$JSStringJSArray(t1).contains$1(t1, word);
},
 getDirectMatchScore$1: function(externalIt) {
  var t1, t2;
  t1 = {};
  t1.result_1 = 0;
  this._hits = $.Set_Set();
  t2 = externalIt.get$_input();
  $.getInterceptor$JSArray(t2).forEach$1(t2, new $.InputText_getDirectMatchScore_anon(this, t1));
  return t1.result_1;
},
 getFilteredInputSize$0: function() {
  var t1, verifiedWords, t2;
  t1 = {};
  t1.filteredSize_1 = 0;
  verifiedWords = $.Set_Set();
  t2 = this._inputSet;
  $.getInterceptor$JSArray(t2).forEach$1(t2, new $.InputText_getFilteredInputSize_anon(verifiedWords, t1, this));
  return t1.filteredSize_1;
},
 highlightText$1: function(externalText) {
  var t1, t2, t3;
  t1 = {};
  t2 = externalText.getText$0();
  t2 = $.getInterceptor$JSString(t2).trim$0(t2);
  t1.text_1 = $.getInterceptor$JSString(t2).toLowerCase$0(t2);
  t3 = this._hits;
  $.getInterceptor$JSArray(t3).forEach$1(t3, new $.InputText_highlightText_anon(t1));
  return t1.text_1;
},
 getText$0: function() {
  return this._originalText;
},
 InputText$1: function(input) {
  var t1, t2;
  this._originalText = input;
  t1 = $.getInterceptor$JSString(input).replaceAll$2(input, $.RegExp_RegExp("[^a-zA-Z 0-9]", false, false), " ");
  this._input = $.getInterceptor$JSString(t1).split$1(t1, " ");
  this._inputSet = $.Set_Set();
  t2 = this._input;
  $.getInterceptor$JSArray(t2).forEach$1(t2, new $.anon(this));
  this.enStopWords = $.Set_Set();
  t2 = $.get$InputText_enStopWordsList();
  $.getInterceptor$JSArray(t2).forEach$1(t2, new $.anon0(this));
}
};
...
$$.main_anon = {"":"Closure;",
 call$1: function(e) {
  ...
  r = $.Ranker$();
  result = $.mul($.div(r.CalculateScore$0(), r.getMaxScore$0()), 100);
  if ($.gtB(result, 100))
    result = 100;
  if ($.getInterceptor$JSNumber(result).get$isNaN(result) === true)
    result = 0;
  t1 = $.getInterceptor$JSNumber(result).toInt$0(result);
  t2 = $.S($.getInterceptor(t1).toString$0(t1)) + "%";
  $.query("#compatibility").set$text(t2);
  t2 = $.queryAll("#result .hint");
  $.getInterceptor$JSArray(t2).forEach$1(t2, new $.main__anon());
  t2 = $.queryAll("#result .result");
  $.getInterceptor$JSArray(t2).forEach$1(t2, new $.main__anon0());
  if ($.gtB(result, 0)) {
    t1 = r.getHighlightedText$0();
    $.query("#matchedText").set$innerHtml(t1);
    $.query("#matchedTextWrapper").get$style().set$display("block");
  }
}
};
...
$$.main__anon0 = {"":"Closure;",
 call$1: function(element) {
  element.get$style().set$display("inline");
}
};
...
$$.InputText_getFilteredInputSize_anon = {"":"Closure;verifiedWords_3,box_0,this_2",
 call$1: function(s) {
  var t1, t2;
  if ($.gtB($.getInterceptor$JSStringJSArray(s).get$length(s), 0)) {
    t1 = this.this_2.get$enStopWords();
    if ($.getInterceptor$JSStringJSArray(t1).contains$1(t1, s) === true) {
      t1 = this.verifiedWords_3;
      t2 = $.getInterceptor$JSStringJSArray(t1).contains$1(t1, s) !== true;
      t1 = t2;
    } else
      t1 = false;
  } else
  ...
  if (t1) {
    t1 = this.box_0;
    t1.filteredSize_1 = $.add(t1.filteredSize_1, 1);
    t1 = this.verifiedWords_3;
...
$$.InputText_highlightText_anon = {"":"Closure;box_0",
 call$1: function(s) {
  var t1, t2;
  t1 = this.box_0;
  t2 = t1.text_1;
  t1.text_1 = $.getInterceptor$JSString(t2).replaceAll$2(t2, s, "<span class=\"highlight\">" + $.S(s) + "</span>");
}
};

$$.InputText_getDirectMatchScore_anon = {"":"Closure;this_2,box_0",
 call$1: function(word) {
  var t1, t2, t3, t4;
  word = $.getInterceptor$JSString(word).toLowerCase$0(word);
  t1 = this.this_2;
  t2 = t1.get$enStopWords();
  if ($.getInterceptor$JSStringJSArray(t2).contains$1(t2, word) !== true && $.gtB($.getInterceptor$JSStringJSArray(word).get$length(word), 1)) {
    t2 = this.box_0;
    t3 = t2.result_1;
    t4 = t1.get$_inputSet();
    t4 = $.getInterceptor$JSStringJSArray(t4).contains$1(t4, word) === true ? t1.get$_DIRECT_SCORE() : 0;
    t2.result_1 = $.add(t3, t4);
    t2 = t1.get$_inputSet();
    if ($.getInterceptor$JSStringJSArray(t2).contains$1(t2, word) === true) {
      $.print("match " + $.S(word));
      t1 = t1.get$_hits();
      $.getInterceptor$JSArray(t1).add$1(t1, word);
    }
  }
}
};
...
$$.anon = {"":"Closure;this_0",
 call$1: function(val) {
  var t1, t2;
  t1 = $.getInterceptor$JSString(val);
  t2 = t1.trim$0(val);
  if ($.geB($.getInterceptor$JSStringJSArray(t2).get$length(t2), 2)) {
    t2 = this.this_0.get$_inputSet();
    $.getInterceptor$JSArray(t2).add$1(t2, t1.toLowerCase$0(val));
  }
}
};
...
$$.anon0 = {"":"Closure;this_1",
 call$1: function(s) {
  var t1 = this.this_1.get$enStopWords();
  $.getInterceptor$JSArray(t1).add$1(t1, $.getInterceptor$JSString(s).toLowerCase$0(s));
}
};
...
$.main = function() {
  var t1 = $.query("#rateitbtn").get$on().get$click();
...
$.Ranker$ = function() {
  var t1 = new $.Ranker(null, null);
  t1.Ranker$0();
  return t1;
};

$.InputText$ = function(input) {
  var t1 = new $.InputText(null, null, null, null, 1, null);
  t1.InputText$1(input);
  return t1;
};
...
//@ sourceMappingURL=rankmycv.dart.js.map